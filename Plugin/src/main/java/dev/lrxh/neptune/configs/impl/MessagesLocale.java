...
public enum MessagesLocale implements IDataAccessor {
    ...
    QUEUE_JOIN("QUEUE.JOIN", DataType.STRING_LIST, "" ", "&#FFD700&lᴄᴀꜱᴜᴀʟ <kit>", " ","),
    ...
    MATCH_FOUND("MATCH.FOUND", DataType.STRING_LIST, " ", "&#FFD700&lᴄᴀꜱᴜᴀʟ <kit>", " ", "&#00A4FC&l❙&r &fᴀʀᴇɴᴀ: &#FFD700<arena>",
                        "&#00A4FC&l❙&r &fᴏᴘᴘᴏɴᴇɴᴛ: &c<opponent>", "&#00A4FC&l❙&r &fᴘɪɴɢ: &c<opponent-ping>", "",
                        " "),
    MATCH_STARTING("MATCH.START.TIMER", DataType.STRING_LIST, "&7<timer>..."),
    MATCH_STARTING_TITLE_HEADER("MATCH.STARTING.TITLE-HEADER", DataType.STRING, "&#FFD700<timer>..."),
    ...
    ROUND_STARTING("MATCH.ROUND.START.TIMER", DataType.STRING_LIST, "&7<timer>..."),
    MATCH_START_TITLE_HEADER("MATCH.START.TITLE-HEADER", DataType.STRING, "&#FFD700&lꜰɪɢʜᴛ!"),
    ...
    MATCH_END_DETAILS_TEAM("MATCH.END_DETAILS_MESSAGE.TEAM", DataType.STRING_LIST,
            " ",
            "&#00A4FC&lᴍᴀᴛᴄʜ ꜱᴜᴍᴍᴀʀʏ",
            "&#00A4FC&l❙&r &fᴡɪɴɴᴇʀ: &#00A4FC<winners>",
            "&#00A4FC&l❙&r &fʟᴏꜱᴇʀ: &#00A4FC<losers>"
            " "),
    MATCH_END_DETAILS_FFA("MATCH.END_DETAILS_MESSAGE.FFA", DataType.STRING_LIST,
            ...
            " "),
    MATCH_RESPAWN_TIMER("MATCH.RESPAWN_TIMER", DataType.STRING_LIST, "&7ʀᴇꜱᴘᴀᴡɴɪɴɢ ɪɴ &#FFD700<timer>&7..."),
    ...
    MATCH_RESPAWN_TITLE_FOOTER("MATCH.RESPAWNED_TITLE_FOOTER", DataType.STRING, "&7ʀᴇꜱᴘᴀᴡɴɪɴɢ ɪɴ &#FFD700<timer>&7..."),
    ...
    MATCH_BOXING_HIT_DIFFERENCE_LOWER("MATCH.HIT_DIFFERENCE_PLACEHOLDER", DataType.STRING,
                        "&c-<hit-difference>"),
    MATCH_BUILD_LIMIT("MATCH.BUILD_LIMIT", DataType.STRING_LIST, "&cʏᴏᴜ ʜᴀᴠᴇ ʀᴇᴀᴄʜᴇᴅ ᴛʜᴇ ʙᴜɪʟᴅ ʟɪᴍɪᴛ!"),
    ...
    DUEL_REQUEST_SENDER("DUEL.SENDER", DataType.STRING_LIST, " ",
            ...
            " "),
    DUEL_DENY_SENDER("DUEL.SENDER_DENY", DataType.STRING_LIST, "&cᴅᴜᴇʟ ᴅᴇɴɪᴇᴅ."),
    DUEL_DENY_RECEIVER("DUEL.RECEIVER_DENY", DataType.STRING_LIST, "&cʏᴏᴜʀ ᴅᴜᴇʟ ᴛᴏ &c<player> &cᴡᴀꜱ ᴅᴇɴɪᴇᴅ."),
    DUEL_ALREADY_SENT("DUEL.ALREADY_SENT", DataType.STRING, "&cʏᴏᴜ ʜᴀᴠᴇ ᴀʟʀᴇᴀᴅʏ ꜱᴇɴᴛ <player> ᴀ ᴅᴜᴇʟ ʀᴇǫᴜᴇꜱᴛ."),
    DUEL_EXPIRED("DUEL.EXPIRED", DataType.STRING_LIST, "&cʏᴏᴜʀ ᴅᴜᴇʟ ʀᴇǫᴜᴇꜱᴛ ᴛᴏ <player> ʜᴀꜱ ᴇxᴘɪʀᴇᴅ."),
    DUEL_NOT_ONLINE("DUEL.NOT_ONLINE", DataType.STRING_LIST, "&cᴘʟᴀʏᴇʀ ɪꜱɴ'ᴛ ᴏɴʟɪɴᴇ!"),
    YOU_CANT_SEND_DUEL("DUEL.YOU_CANT_SEND_DUEL", DataType.STRING_LIST, "&cʏᴏᴜ ᴄᴀɴ'ᴛ ꜱᴇɴᴅ ᴅᴜᴇʟ ʀᴇǫᴜᴇꜱᴛꜱ ʀɪɢʜᴛ ɴᴏᴡ!"),
    CANT_DUEL_SELF("DUEL.CANT_DUEL_SELF", DataType.STRING_LIST, "&cʏᴏᴜ ᴄᴀɴ'ᴛ ᴅᴜᴇʟ ʏᴏᴜʀꜱᴇʟꜰ!"),
    PLAYER_CANT_ACCEPT_DUEL("DUEL.PLAYER_CANT_ACCEPT_DUEL", DataType.STRING_LIST,
            "&cᴘʟᴀʏᴇʀ ᴄᴀɴ'ᴛ ᴀᴄᴄᴇᴘᴛ ᴅᴜᴇʟ ʀᴇǫᴜᴇꜱᴛꜱ!"),
    YOU_DONT_HAVE_DUEL_REQUEST("DUEL.YOU_DONT_HAVE_DUEL_REQUEST", DataType.STRING_LIST,
            "&cʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀɴʏ ᴅᴜᴇʟ ʀᴇǫᴜᴇꜱᴛ ꜰʀᴏᴍ ᴛʜɪꜱ ᴘʟᴀʏᴇʀ!"),
    DUEL_REQUEST_COULDNT_BE_ACCEPTED("DUEL.REQUEST_COULDNT_BE_ACCEPTED", DataType.STRING_LIST,
            "&cᴅᴜᴇʟ ʀᴇǫᴜᴇꜱᴛ ᴄᴏᴜʟᴅɴ'ᴛ ʙᴇ ᴀᴄᴄᴇᴘᴛᴇᴅ!")
    ...
    REMATCH_REQUEST_SENDER("REMATCH.SENDER", DataType.STRING_LIST, " ",
            ...
            " "),
    REMATCH_EXPIRED("REMATCH.EXPIRED", DataType.STRING_LIST, "&cʏᴏᴜʀ ʀᴇᴍᴀᴛᴄʜ ʀᴇǫᴜᴇꜱᴛ ᴛᴏ <player> ʜᴀꜱ ᴇxᴘɪʀᴇᴅ."),
    SPECTATE_START("MATCH.SPECTATE.START", DataType.STRING_LIST, "&#00A4FC<player> &7ꜱᴛᴀʀᴛᴇᴅ ꜱᴘᴇᴄᴛᴀᴛɪɴɢ."),
    MATCH_FORFEIT("MATCH.FORFEIT", DataType.STRING_LIST, "&cꜱᴏᴍᴇᴏɴᴇ ʀᴀɢᴇ ǫᴜɪᴛ!"),
    SPECTATE_STOP("MATCH.SPECTATE.STOP", DataType.STRING_LIST, "&#00A4FC<player> &7ꜱᴛᴏᴘᴘᴇᴅ ꜱᴘᴇᴄᴛᴀᴛɪɴɢ."),
    ...
    SPECTATE_STARTED("MATCH.SPECTATE.START", DataType.STRING_LIST,
            "&7ʏᴏᴜ ꜱᴛᴀʀᴛᴇᴅ ꜱᴘᴇᴄᴛᴀᴛɪɴɢ &#00A4FC<player>&7."),
    SPECTATE_STARTED_SILENT("MATCH.SPECTATE.START.SILENT", DataType.STRING_LIST,
            "&7ʏᴏᴜ ꜱɪʟᴇɴᴛʟʏ ꜱᴘᴇᴄᴛᴀᴛɪɴɢ &#00A4FC<player>&7."),
