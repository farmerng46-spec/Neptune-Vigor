...
public enum MessagesLocale implements IDataAccessor {
    ...
    QUEUE_JOIN("QUEUE.JOIN", DataType.STRING_LIST, " " ", "&#FFD700&lᴄᴀꜱᴜᴀʟ <kit>", "&7ꜱᴇᴀʀᴄʜɪɴɢ ꜰᴏʀ ᴍᴀᴛᴄʜ…",""),
    ...
    MATCH_END_DETAILS_FFA("MATCH.END_DETAILS_MESSAGE.FFA", DataType.STRING_LIST,
            ...
            " "),
    MATCH_RESPAWN_TIMER("MATCH.RESPAWN_TIMER", DataType.STRING_LIST, "&7ʀᴇꜱᴘᴀᴡɴɪɴɢ ɪɴ &#00A4FC<timer>&7..."),
